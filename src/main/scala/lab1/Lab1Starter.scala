...
object Lab1Starter {
  def main(array: Array[String]) {
    Helper.printVariant()
    val neDushitePlzTimer = System.currentTimeMillis()
    ...
    val neDushitePlzTimerEnd = System.currentTimeMillis()
    ...
    println(f"EXECUTION TIME = ${neDushitePlzTimerEnd-neDushitePlzTimer}")
